...
const api: MuseAPI = {
  ...
  assets: {
    ...
    setFavorite: (assetIds, favorite) => ipcRenderer.invoke(IPC.assets.setFavorite, { assetIds, favorite }),
  ...
  desktop: {
    ...
    startAssetDrag: (assetIds) => ipcRenderer.send(IPC.desktop.startAssetDrag, assetIds),
